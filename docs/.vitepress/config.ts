...
export default defineConfig({
  ...
  head: [
    ...
    [
      "link",
      { rel: "epic-icon", type: "image/x-icon", href: "/front-design/favicon.ico" },
    ],
  ],
  // 主题配置
  themeConfig: {
    ...
    editLink: {
      text: "为此页提供修改建议",
      pattern: "https://github.com/Kchengz/front-design/issues",
    },

    socialLinks: [
      { icon: "github", link: "https://github.com/Kchengz/front-design" },
    ],
    footer: {

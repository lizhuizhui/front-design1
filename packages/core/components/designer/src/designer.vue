...
import { DesignerState, ComponentSchema, PageSchema } from '../../../types/front-design'
import { getMatchedById, loadAsyncComponent, revoke, usePageManager, pluginManager, deepCompareAndModify, deepEqual, deepClone } from '@front-design/utils'
import { DesignerProps } from './types'
import { useShareStore } from '@front-design/utils'
...
function setComponentSchemaGroups(data) {
  pluginManager.setComponentSchemaGroups(data)
}
